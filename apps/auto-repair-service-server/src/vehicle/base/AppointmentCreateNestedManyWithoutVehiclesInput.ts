...
@InputType()
class AppointmentCreateNestedManyWithoutVehiclesInput {
...
export { AppointmentCreateNestedManyWithoutVehiclesInput as AppointmentCreateNestedManyWithoutVehiclesInput };
