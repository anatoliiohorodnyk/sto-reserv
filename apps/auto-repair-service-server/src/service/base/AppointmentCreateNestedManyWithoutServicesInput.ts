...
@InputType()
class AppointmentCreateNestedManyWithoutServicesInput {
...
export { AppointmentCreateNestedManyWithoutServicesInput as AppointmentCreateNestedManyWithoutServicesInput };
