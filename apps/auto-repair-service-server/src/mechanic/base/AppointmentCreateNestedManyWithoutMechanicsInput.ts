...
@InputType()
class AppointmentCreateNestedManyWithoutMechanicsInput {
...
export { AppointmentCreateNestedManyWithoutMechanicsInput as AppointmentCreateNestedManyWithoutMechanicsInput };
